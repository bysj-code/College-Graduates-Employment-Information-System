                ...
                <scroll-view scroll-y="true" class="tabView" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"10rpx 0 0 ","borderColor":"rgba(0,0,0,1)","borderRadius":"0","borderWidth":"0","width":"150rpx","borderStyle":"solid","height":"auto"}'>
                    <view style="display: flex;flex-direction: column;">
                        <view :style='zhaopinTypes===item.codeIndex?sactiveItem:sitem' class="tab"
                              v-for="(item,index) in zhaopinTypesList" :key="index"
                              :class="zhaopinTypes===item.codeIndex?'tabActive':''"
                              @tap="zhaopinTypesCategoryClick(item.codeIndex)">{{item.indexName}}</view>
                    </view>
                </scroll-view>
            </uni-drawer>
<view class="list"
    ...
    <view @tap="onDetailTap(product)" class="listm flex flex-between"
        ...
        <image
                ...
                :src="product.zhaopinPhoto?baseUrl+product.zhaopinPhoto.split(',')[0]:''"></image>
        <view class="listmr" style="padding: 10rpx ;">
            ...
            <view class="hide1" v-if="product.zhaopinNewMoney"
                ...
                ￥{{product.zhaopinNewMoney}}
            </view>
            <view class="hide1" v-else-if="product.zhaopinValue"
                  :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"rgba(0, 0, 0, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","fontSize":"30rpx","lineHeight":"56rpx","borderStyle":"solid"}'>
                {{product.zhaopinValue}}
            </view>
