...
import huanyuan from '@/views/modules/databaseBackup/huanyuan'
    ...
    import gongzuopingjia from '@/views/modules/gongzuopingjia/list'
    import jinsheng from '@/views/modules/jinsheng/list'
    ...
    import dictionaryMianshishenqingYesno from '@/views/modules/dictionaryMianshishenqingYesno/list'
    ...
    import gongzuopingjiaAdd from '@/views/modules/gongzuopingjia/add-or-update'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryMianshishenqingYesno',
        name: '申请状态',
        component: dictionaryMianshishenqingYesno
    }
	,{
	    path: '/gongzuopingjiaAdd',
	    name: '添加工作评价',
	    component: gongzuopingjiaAdd
	}
    ,{
        path: '/dictionaryNews',
        name: '公告信息类型',
