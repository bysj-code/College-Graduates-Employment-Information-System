	...
	<script>
		export default {
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.info('jinsheng', this.jinshengId);
                    this.detail = res.data
					// 主图
					this.swiperList = this.detail.jinshengPhoto ? this.detail.jinshengPhoto.split(",") : [];
				},
