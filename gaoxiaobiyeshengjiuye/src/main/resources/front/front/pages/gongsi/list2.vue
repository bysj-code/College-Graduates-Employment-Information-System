	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        <view class="search-form round">
				<input :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"0px","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
						v-model="searchForm.gongsiName" type="text" placeholder="公司名称"></input>
		</view>
...
<view class="list"
    ...
    <view @tap="onDetailTap(product)" class="listm flex flex-between"
        ...
        <image
                ...
                :src="product.gongsiPhoto?baseUrl+product.gongsiPhoto.split(',')[0]:''"></image>
        <view class="listmr" style="padding: 10rpx ;">
            ...
            <view class="hide1" v-if="product.gongsiNewMoney"
                ...
                ￥{{product.gongsiNewMoney}}
            </view>
            <view class="hide1" v-else-if="product.gongsiValue"
                  :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"rgba(0, 0, 0, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","fontSize":"30rpx","lineHeight":"56rpx","borderStyle":"solid"}'>
                {{product.gongsiValue}}
            </view>
