    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="公司名称" prop="jinshengName">
                       <el-input v-model="ruleForm.jinshengName"
                                 placeholder="公司名称" clearable  :readonly="ro.jinshengName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="公司名称" prop="jinshengName">
                           <el-input v-model="ruleForm.jinshengName"
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="具体时间" prop="jinshengTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.jinshengTime"
                                type="datetime"
                                placeholder="具体时间"
                                :disabled="ro.jinshengTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jinshengTime" label="具体时间" prop="jinshengTime">
                            <span v-html="ruleForm.jinshengTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="相关情况" prop="jinshengText">
                        <el-input type="textarea"  :readonly="ro.jinshengText" v-model="ruleForm.jinshengText" placeholder="相关情况"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jinshengText" label="相关情况" prop="jinshengText">
                            <span v-html="ruleForm.jinshengText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jinshengText: [
                              { required: true, message: '相关情况不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jinsheng/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jinshengCrossAddOrUpdateFlag = false;
                                        this.parent.search();
