	...
	<script>
		export default {
			...
			async onLoad(options) {
				this.mianshishenqingId = options.id;
			},
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.info('mianshishenqing', this.mianshishenqingId);
                    this.detail = res.data
					// 主图
					this.swiperList = this.detail.mianshishenqingPhoto ? this.detail.mianshishenqingPhoto.split(",") : [];
				},
