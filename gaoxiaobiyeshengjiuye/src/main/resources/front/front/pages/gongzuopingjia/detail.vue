	...
	<script>
		export default {
			...
			async onLoad(options) {
				this.gongzuopingjiaId = options.id;
			},
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.info('gongzuopingjia', this.gongzuopingjiaId);
                    this.detail = res.data
					// 主图
					this.swiperList = this.detail.gongzuopingjiaPhoto ? this.detail.gongzuopingjiaPhoto.split(",") : [];
				},
