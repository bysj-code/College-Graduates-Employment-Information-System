			...
			<el-row>
				<el-col :span="12" v-if="sessionTable !='gongsi'">
					<el-form-item class="select" v-if="type!='info'" label="公司" prop="gongsiId">
						<el-select v-model="ruleForm.gongsiId" :disabled="ro.gongsiId" filterable placeholder="请选择公司"
							@change="gongsiChange">
							<el-option v-for="(item,index) in gongsiOptions" v-bind:key="item.id"
								:label="item.gongsiName" :value="item.id">
							</el-option>
						</el-select>
					</el-form-item>
				</el-col>
				...
				<el-col :span="12" v-if="sessionTable !='gongsi' ">
					<el-form-item class="input" v-if="type!='info'" label="公司名称" prop="gongsiName">
						<el-input v-model="gongsiForm.gongsiName" placeholder="公司名称" clearable readonly></el-input>
					</el-form-item>
					<div v-else-if="type=='info'">
						<el-form-item class="input" label="公司名称" prop="gongsiName">
							<el-input v-model="ruleForm.gongsiName" placeholder="公司名称" readonly></el-input>
						</el-form-item>
					</div>
				</el-col>
				<el-col :span="12" v-if="sessionTable !='gongsi' ">
					<el-form-item class="input" v-if="type!='info'" label="公司类型" prop="gongsiValue">
						<el-input v-model="gongsiForm.gongsiValue" placeholder="公司类型" clearable readonly></el-input>
					</el-form-item>
					<div v-else-if="type=='info'">
						<el-form-item class="input" label="公司类型" prop="gongsiValue">
							<el-input v-model="ruleForm.gongsiValue" placeholder="公司类型" readonly></el-input>
						</el-form-item>
					</div>
				</el-col>
				<el-col :span="12" v-if="sessionTable !='gongsi' ">
					<el-form-item class="input" v-if="type!='info'" label="联系方式" prop="gongsiPhone">
						<el-input v-model="gongsiForm.gongsiPhone" placeholder="联系方式" clearable readonly></el-input>
					</el-form-item>
					<div v-else-if="type=='info'">
						<el-form-item class="input" label="联系方式" prop="gongsiPhone">
							<el-input v-model="ruleForm.gongsiPhone" placeholder="联系方式" readonly></el-input>
						</el-form-item>
					</div>
				</el-col>
				<el-col :span="12" v-if="sessionTable !='gongsi' ">
					<el-form-item class="input" v-if="type!='info'" label="邮箱" prop="gongsiEmail">
						<el-input v-model="gongsiForm.gongsiEmail" placeholder="邮箱" clearable readonly></el-input>
					</el-form-item>
					<div v-else-if="type=='info'">
						<el-form-item class="input" label="邮箱" prop="gongsiEmail">
							<el-input v-model="ruleForm.gongsiEmail" placeholder="邮箱" readonly></el-input>
						</el-form-item>
					</div>
				</el-col>
				<el-col :span="12" v-if="sessionTable !='gongsi' ">
					<el-form-item class="upload" v-if="type!='info' && !ro.gongsiPhoto" label="公司封面" prop="gongsiPhoto">
						<img style="margin-right:20px;" v-bind:key="index"
							v-for="(item,index) in (gongsiForm.gongsiPhoto || '').split(',')" :src="$base.url+item"
							width="100" height="100">
					</el-form-item>
					<div v-else-if="type=='info'">
						<el-form-item v-if="ruleForm.gongsiPhoto" label="公司封面" prop="gongsiPhoto">
							<img style="margin-right:20px;" v-bind:key="index"
								v-for="(item,index) in (ruleForm.gongsiPhoto || '').split(',')" :src="$base.url+item"
								width="100" height="100">
						</el-form-item>
					</div>
				</el-col>
				<el-col :span="12" v-if="sessionTable !='yonghu'">
					<el-form-item class="select" v-if="type!='info'" label="用户" prop="yonghuId">
						<el-select v-model="ruleForm.yonghuId" :disabled="ro.yonghuId" filterable placeholder="请选择用户"
							@change="yonghuChange">
							<el-option v-for="(item,index) in yonghuOptions" v-bind:key="item.id"
								:label="item.yonghuName" :value="item.id">
							</el-option>
						</el-select>
					</el-form-item>
				</el-col>
				...
				<el-col :span="24">
					<el-form-item v-if="type!='info'" label="评价内容" prop="gongzuopingjiaText">
						<el-input type="textarea" :readonly="ro.gongzuopingjiaText"
							v-model="ruleForm.gongzuopingjiaText" placeholder="评价内容"></el-input>
					</el-form-item>
					<div v-else-if="type=='info'">
						<el-form-item v-if="ruleForm.gongzuopingjiaText" label="评价内容" prop="gongzuopingjiaText">
							<span v-html="ruleForm.gongzuopingjiaText"></span>
						</el-form-item>
					</div>
				</el-col>
			</el-row>
...
<script>
	...
	export default {
		...
		created() {
			...
			if (this.$route.query.gongsiId && this.$route.query.yonghuId) {
				this.ro.gongsiId = true
				this.ruleForm.gongsiId = this.$route.query.gongsiId
				this.gongsiChange(this.ruleForm.gongsiId)
		...
		methods: {
			...
			onSubmit() {
				this.$refs["ruleForm"].validate(valid => {
					if (valid) {
						this.$http({
							url: `gongzuopingjia/${!this.ruleForm.id ? "save" : "update"}`,
							method: "post",
							data: this.ruleForm
						}).then(({
							data
