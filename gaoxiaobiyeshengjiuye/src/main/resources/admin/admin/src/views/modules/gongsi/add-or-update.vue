               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="公司名称" prop="gongsiName">
                       <el-input v-model="ruleForm.gongsiName"
                                 placeholder="公司名称" clearable  :readonly="ro.gongsiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="公司类型" prop="gongsiTypes">
                        <el-select v-model="ruleForm.gongsiTypes" :disabled="ro.gongsiTypes" placeholder="请选择公司类型">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="gongsiPhone">
                       <el-input v-model="ruleForm.gongsiPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.gongsiPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="gongsiEmail">
                       <el-input v-model="ruleForm.gongsiEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.gongsiEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="公司简介" prop="gongsiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.gongsiContent" label="公司简介" prop="gongsiContent">
                            <span v-html="ruleForm.gongsiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   gongsiPhoto: [
                              { required: true, message: '公司封面不能为空', trigger: 'blur' },
                          ],
                   gongsiContent: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.gongsiContent = _this.ruleForm.gongsiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.gongsiContent = this.ruleForm.gongsiContent.replaceAll(this.$base.url,"");
                        this.$http({
