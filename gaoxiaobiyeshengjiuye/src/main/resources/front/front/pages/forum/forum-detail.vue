<template>
	<view>
		...
		<view class="content" style="width: 100%;">
			...
			<!-- <view class="aaa" v-html="forum.forumContent"> </view> -->
		</view>
...
<script>
	...
	export default {
		...
		async onLoad(options) {
			...
			this.forum = res.data;
			this.forum.forumContent = this.forum.forumContent.replace("<img","<img class=\'daxiao\'").replace("src=\"upload/","src=\""+this.$base.url+"upload/" );
